...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(0, self.numParticles):
            uniform_dist.append(i % len(self.legalPositions))

        for i in range(0, len(uniform_dist)):
            self.particles.append(self.legalPositions[uniform_dist[i]])

        # for i in range(0, self.numParticles):
        #     uniform_dist.append(random.uniform(0, len(self.legalPositions) - 1))
        #
        # for i in range(0, len(uniform_dist)):
        #     self.particles.append(self.legalPositions[uniform_dist[i]])
