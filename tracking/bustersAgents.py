...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            ...
            maze_dist = self.distancer.getDistance(ghost_pos[0], pacmanPosition)
        ...
        actions = []
        for action in legal:
            maze_dist = self.distancer.getDistance(closest_ghost[0][0], Actions.getSuccessor(pacmanPosition, action))
